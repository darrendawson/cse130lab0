...
# List the sources, separated by spaces, for your program. 'SOURCES=foo.c bar.c', for
...
# Generate a list of object files from the source files. If SOURCES is 'foo.c bar.c', then
...
# manually, like 'foo.c: foo.h bar.h' if you want, but the method in this makefile generates them
# automatically.
DEPS=$(SOURCES:.c=.d)
